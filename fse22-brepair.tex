...
exeed a user-configured value, a constant number of threads are sampled for
continuation. Then, each thread is processed individually. On each thread,
a set of repairs (\Cref{lst:repairs}) are applied. If the repair succeeds,
