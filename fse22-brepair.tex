...
We evaluate \brepair on \recheck{806} (real-world) invalid inputs using four well-known input formats, namely INI, TinyC, SExp, and cJSON. In our evaluation, we found that it is highly effective and efficient in input repair. It repairs \recheck{81}\% of invalid inputs and recovers \recheck{98\%} of input data, within two minutes. It is up to \recheck{18\%} more effective than \ddmax -- the previously best known approach. 
...
The rest of this paper is sturctured as follows:\todo{describe sections/order}
