...
As subjects we used four input formats and their corresponding programs. These are INI (INI), JSON (cJSON), S-Expressions (SExpParser) and TinyC (TinyC). Each program is moderately large (between 300 LOC to 3,000 LOC), relatively mature (6 to 21 years old), and is written in \<C>. The details are provided in \Cref{tab:subject-programs}.
