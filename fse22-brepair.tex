...
One of the patterns in which \ddmax can fail is when the corruption in the
input interacts with the fragment decomposition algorithm in \ddmax.
...
\letterboxed{*}. This results in a repair of \letterboxed{\ \ \ \ 3.45},
resulting in information loss.

The problem here is that the successive partitions attempted by \ddmax fails to
isolate the failure causing fragment eventhough the fragment is contiguous.
...
\subsection{Other Issues with \ddmax}
