...
we used 482 inputs that were completely repaired by all three approaches, i.e., lexical \ddmax, syntactic \ddmax and \approach. \Cref{tab:data-recovery} %and \recheck{Figure X
highlights the data %loss and data
recovery achieved by each approach. %Our evaluation r
Results show that \textit{\approach recovered up to 84\% of input data and which is up to 25\% more than the most effective baseline (syntactic ddmax).} %Notably, f
