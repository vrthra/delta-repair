...
\begin{tikzpicture}[node distance=\nodedst]
    ...
    \node[blockdiagramblock,below=of search] (pop) {Select Repair Thread};
    ...
    \node[blockdiagramblock,right=of correct] (tryDelete) {Apply Repairs};
    \node[blockdiagramblock,above=of tryDelete] (tryNewInsert) {Extend Threads};
    ...
    \pic[] at (pop.south east) {numbering=4};
