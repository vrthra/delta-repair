...
insights~\cite{scaffidi2008accommodating}. \todo{add concrete example use case} Unfortunately, data sources may disagree on the format specification, %e.g.,
%\recheck{
...
an official formal grammar specification. Others may have numerous standards
