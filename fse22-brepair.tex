...
Unconstrained insertions are possible only for a single character, and if we
have constraints on the initial character, we should limit the total number of
choices, beyond which deletion should take precedence.
}
