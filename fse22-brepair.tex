...
In this paper, we propose \brepair\footnote{\recheck{\brepair denotes "Fixing invalid input via input SYNTHesis".}}
...
\begin{tikzpicture}[node distance=\nodedst]
    \node[blockdiagramblock] (search) {Find parse boundary};
