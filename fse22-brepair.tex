...
def check_is_incomplete(sval, i):
    return is_incomplete(Repair(sval, i))
...
def repair_and_extend(item):
    e_arr = [extend_deleted_item(apply_delete(item))]
    for i in apply_insert(item):
        old_boundary = i.boundary
        ie = extend_inserted_item(i)
...
def repair_and_extend(item):
    e_arr = [extend_deleted_item(apply_delete(item))]
    e_arr = [extend_deleted_item(apply_insert(item))]
