...
In our comparison to grammar-based input repair techniques, we employ the built-in error-recovery strategy of the \textit{ANTLR} parser generator, and \textit{syntactic ddmax}  (\textit{see}  \Cref{tab:effectiveness-grammar}). 
...
\Cref{tab:effectiveness-no-grammar},  \Cref{tab:effectiveness-grammar} and \Cref{fig:effectiveness} highlight the (overall) effectiveness of \approach in contrast to the state-of-the-art methods. 
