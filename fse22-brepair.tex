...
\ddmax_2(\dpass, n) &=
\begin{cases}
\ddmax_2(\cfail - \Delta_i, 2) & \text{\hphantom{else }if $\exists i \in \{1, \dots, n\} \cdot \test(\cfail - \Delta_i) = \pass$ (``increase to complement'')} \\
%
...
%
\ddmax_2\bigl(\dpass, \min(|\cfail|, 2n)\bigr) & \text{else if $n < |\cfail - \dpass|$ (``increase granularity'')} \\
