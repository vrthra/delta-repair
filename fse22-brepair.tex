...
is complementary to the best state-of-the-art method (syntactic \ddmax). 
It is the only technique that can solely complete 9\% of all repairs, which is up to five times as much as \ddmax.
\end{result}
