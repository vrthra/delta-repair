...
Data cleansing and data repair are time-consuming tasks for developers, especially in fields that aggregate data from multiple resources (e.g., data warehousing). Oftentimes,
...
%invalid inputs,
\textit{\brepair is highly effective, 
it repairs 77\% of invalid inputs and recovers 91\% of input data, within four minutes.}
% and recovers 91% of input data,
% (77\% repairs within four minutes), and 
It is also up to 35\% more effective than \ddmax, the best state-of-the-art input repair method.
...
%\revise{
We provide our tool, data and experimental results for easy replication, scrutiny and reuse:
%}
