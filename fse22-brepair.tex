...
def find_fixes(threads):
    ...
    while True:
        ...
        comp = []
        for item in sample_items_by_mask(cur_items):
        ...
        edit_dist += 1
\end{lstlisting}
The function \<find\_fixes()> takes in a set of threads, 
extracts threads corresponding to the least edit distance, and applies a set of
repairs on it which are defined in \Cref{lst:repairs}. If the repair succeeds,
