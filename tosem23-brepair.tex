...
Consequently, data engineers must perform \emph{data repair,} manually
...
WHATWG~\cite{whatwgurl,urldisagree}) may not have an official formal grammar specification.
Others may have numerous incompatible standards
(e.g., markdown~\cite{gruber2004markdown}), any of which may be followed by the
parser in question, and in many cases the parser may be handwritten~\cite{uncommongrammars,uncommongrammars2}, and non-conformant due to bugs or quirks,
...
\item \textbf{Empirical Evaluation.} We evaluate \brepair using 806 (real-world) non-conforming
