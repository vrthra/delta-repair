...
that an input record can be processed by a given parser because the parser may
...
Firstly,
certain input formats (e.g., CSV~\cite{taocp}, URL standard from
...
Hence, grammar-based input repair approaches
...
\hline
\textbf{Examples of Invalid}& \textbf{\ddmax} & \textbf{\brepair} & \textbf{\ddmax} \\
