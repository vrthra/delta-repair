...
\begin{tikzpicture}[node distance=\nodedst]
    ...
    \node[blockdiagramblock,right=2 of search] (pop) {Pop element from PQ};
    \draw[blockdiagramarrow] (search) -- (pop) node[simpletext,pos=.5,above,font=\scriptsize] {Push prefix to PQ};
    ...
    \draw[blockdiagramarrow] ([xshift=-2 * \arrowsep]tryOrigInsert.north) to[out=90,in=270,looseness=0.4] node[simpletext,pos=.5,above,sloped,inner sep=1pt] {Incomplete?} (search);
