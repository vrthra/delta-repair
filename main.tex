...
\hline
\textbf{Real-Word Inputs} & 101 & 107 & 50 & 148 \\
...
We evaluate the effectiveness of our approach using \recheck{806} invalid input files from \recheck{four} input formats, namely INI, JSON, SEXP, and TINYC.  \recheck{Table X} provides details of the number of real-world and mutated invalid inputs for each input format. In this experiment, 
%and efficiency of our approach 
%Specifically, 
we measure the total number of files repaired by our approach, in comparison to the number of repairs achieved % compare to %as well as 
...
In summary, these results suggest that (a) \approach is highly effective in repairing invalid input files, (b) our approach more effective than the baselines, and (c) the combination of rich failure feedback and input synthesis is important for the effective repair of invalid input files. 
...
\hline
\textbf{Both} &  201 & 105 & 121 & 84 & 511 \\
\textbf{Ddmax Only} & 0 & 17 & 3 & 22 & 42 \\
\textbf{\approach Only} & 0 & 68 & 1 & 70 & 139 \\
\hline
...
%\hline
\end{tabular}
\label{tab:repair-complementary}
%\vspace{-0.5cm}
\end{table}


\noindent \textit{Compleme:}
