...
A final example is the input \letterboxed{"abcd":[1,2,3]\}}.
\begin{enumerate}
...
As you can see from the previous section, \drepair is an effective approach to input repair, but
has a few blind spots. In this section, we discuss how we can mitigate these blind spots.
...
at the end of the viable-prefix, but also at all points in the viable-prefix. 
