...
(3) a starting minimal subsequence of the input that is valid
\ddmax successively identifies input fragments that when inserted into the 
minimal valid subsequence, avoids triggering the error.
