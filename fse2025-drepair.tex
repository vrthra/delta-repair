...
As with \ddmax, we have a few requirements. We need (1) a way to decompose the
record into tokens, (2) a way to identify valid tokens. However, instead of (3)
a minimal starting sequence, which may not always be available, we only require
the following:
...
When given a nonconforming record,
