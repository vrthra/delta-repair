...
\item[\textbf{(2) Lexical \ddmax:}] As the second baseline, we compare the
  \emph{format-agnostic} lexical \ddmax described by Kirschner et al.~\cite{kirschner2020debugging}.
    This is the previous state-of-the-art when compared to \drepair (which is
    also format-agnostic).
\end{description}


\noindent{\textbf{Format-aware}.}
...
\begin{description}[wide]
\item[\textbf{(3) ANTLR:}] We use ANTLR as the first baseline format-aware
...
\centering
  \caption{For \textbf{format-agnostic} \dtask approaches.}
...
\begin{subtable}{\textwidth}
\centering
  \caption{For \textbf{format aware} repair approaches.}
\begin{tabular}{|p{4.0cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.5cm}|}
\hline
&  \multicolumn{4}{c|}{\textbf{Number of Repaired Records}}  \\
&  \multicolumn{1}{c|}{\textbf{ALL}} & \multicolumn{3}{c|}{\textbf{Data Format}}  \\
