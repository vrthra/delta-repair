...
\item[\textbf{(1) Baseline:}] As in the Kirschner et al., we use the built in
...
\item[\textbf{(3) Lexical \ddmax:}] This is the language agnostic version described by Kirschner et al.~\cite{kirschner2020debugging}
