...
and (1) a way to decompose the record into independent tokens ($\delta$s),
(2) a way to identify valid inputs, and
(3) a starting minimal subsequence of the input that is valid
\ddmax successively concatenates parts of the input that when added, does
not induce an error. This procedure isolates and removes the parse-error
