...
\begin{result}
\approach is 
effective in input repair. %, and more effective than the state-of-the-art.
...
\noindent\textbf{Construct Validity} This concerns the test oracle and parse-failure feedback employed in our evaluation. To ensure all subjects provide the expected \textit{incomplete} and \textit{(in)correct} feedback, we tested the programs on sample invalid inputs and modified the subject program, if needed. 
