...
The repair effectiveness for format-agnostic
(i.e., without the knowledge of specification) and format-based
(i.e., those that only work when the data-format specification is given)
methods are tabulated in \Cref{tab:effectiveness}, and compared against \drepair.
...
\emph{format-agnostic}
and \emph{format-aware}  techniques (\Cref{tab:effectiveness}).
