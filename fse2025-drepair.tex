...
However, this may not be the whole story. We also capture the distance
from corrupted to repaired in \Cref{tab:invalidtorepaired}

%To fully understand why this has happened,
How much does the \emph{insertion} operation matter? To evaluate that, let us
consider
...
DDMax & 2.26 & 24.42 & 2.94 & 9.87 \\
DDMaxG & 262.90 & 183.02 & 11.38 & 152.43 \\
bRepair & 0.44 & 4.44 & 0.62 & 1.83 \\
\hline
\end{tabular}
\label{tab:delops}
\end{table}
